  ...
  return (
    <div className="wordbook-list__paginator">
      <div className="paginator-container">
        <div className="wordbook-list__paginator--first" onClick={handlePagination} data-pagetarget="first">
          1
        </div>
        <div className="wordbook-list__paginator--left" onClick={handlePagination} data-pagetarget="left">
          <FaAngleLeft className="left-arrow" data-pagetarget="left" />
        </div>
        <div className="wordbook-list__paginator--current">{currentPage}</div>
        <div className="wordbook-list__paginator--right" onClick={handlePagination} data-pagetarget="right">
          <FaAngleRight className="right-arrow" data-pagetarget="right" />
        </div>
        <div className="wordbook-list__paginator--last" onClick={handlePagination} data-pagetarget="last">
          {totalPage}
        </div>
      </div>
    </div>
